...
<img src="https://cdn.nlark.com/yuque/0/2025/png/2813699/1757319386217-df0365ac-98c1-4dad-86e7-90b3eef187b6.png?x-oss-process=image%2Fformat%2Cwebp" alt="image-20250908160759488.png" style="zoom:50%;" />
...
实现对vue,vite，webpack，vite构建配置的封装，以满足多项目时能快速搭建项目
...
- 我不需要太复杂的东西，请基于我的文件进行优化@/npm/shared/src/config/build 
  1.我需要的是vue-cli下创建一个vue2的构建类，请参考@/npm/shared/src/config/build/webpack/webpack.base.js 
  2.后续我还会拓展webpack类，qiankun类，react类，vite类，所以请基于core将公共的方法或者变量放在core中
  2.@/npm/shared/src/config/build/core/env/index.ts 这里是获取环境变量的，会从每个项目下的$lm-config/env下获取，@/packages/vue-demo-pc/$lm-config ，当然若考虑后续兼容性，可以按照这种方法获取

##### 目录结构

ai给出的结论

![image-20251101142746482](img/总结/image-20251101142746482.png)
...
- cross-env设置process.env下的环境变量

- node的fs获取在项目中设置的$lm-config/env下的对应的环境文件
