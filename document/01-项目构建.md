...
- rollup使用preserveModules，为什么打包生成的是一个函数，必须要执行
...
-  ERR_PNPM_INCLUDED_DEPS_CONFLICT  modules directory (at "D:\work\demo\front\qiankun") was inst
  alled with dependencies, devDependencies. Current install wants optionalDependencies, dependen
  cies, devDependencies.
